...
type VaultTab = "proposals" | "logs" | "services" | "credentials" | "policies" | "users" | "agents" | "settings";
...
export default function VaultLayout() {
  ...
  const activeTab: VaultTab = ["proposals", "logs", "services", "credentials", "policies", "users", "agents", "settings"].includes(lastSegment)
    ? lastSegment
    : "services";
